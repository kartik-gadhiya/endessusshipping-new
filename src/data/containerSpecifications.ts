...
export const containers: ContainerSpec[] = [
  ...
  },
  {
    ...
    image: "/assets/container_specifications/20ft_reefer_v4.png",
    interiorDimensions: {
      length: "L: 5.450 m 17'10 1/2\"",
      width: "W: 2.280 m 7'5 3/4\"",
      height: "H: 2.159 m 7'1\"",
    },
    doorOpening: {
      width: "W: 2.290 m 7'6 1/8\"",
      height: "H: 2.264 m 7'5 1/8\"",
    },
    topsOpening: "",
    tareWeight: "2,860 kg 6,306 lbs.",
    cubicCapacity: "28.1 cbm 992 cu. ft.",
    payload: "29,140 kg 64,243 lbs.",
  },
  {
    id: 8,
    name: "40' High Cube Reefer Container",
    image: "/assets/container_specifications/40ft_reefer_hc_v4.png",
    interiorDimensions: {
      length: "L: 11.599 m 38'0 5/8\"",
      width: "W: 2.290 m 7'6 1/8\"",
      height: "H: 2.425 m 7'11 1/2\"",
    },
    doorOpening: {
      width: "W: 2.290 m 7'6 1/8\"",
      height: "H: 2.557 m 8'4 5/8\"",
    },
    topsOpening: "",
    tareWeight: "4,520 kg 9,965 lbs.",
    cubicCapacity: "67.7 cbm 2,391 cu. ft.",
    payload: "29,480 kg 64,992 lbs.",
  },
  {
    id: 9,
    name: "40' Reefer Container",
    image: "/assets/container_specifications/40ft_reefer_v4.png",
    interiorDimensions: {
      length: "L: 11.557 m 37'11\"",
      width: "W: 2.286 m 7'6\"",
      height: "H: 2.286 m 7'6\"",
    },
    doorOpening: {
      width: "W: 2.286 m 7'6\"",
      height: "H: 2.286 m 7'6\"",
    ...
    topsOpening: "",
    tareWeight: "4,400 kg 9,700 lbs.",
    cubicCapacity: "58.1 cbm 2,051 cu. ft.",
    payload: "26,059 kg 57,450 lbs.",
  },
  {
    id: 10,
...
export const organizedContainers: ContainerGroup[] = [
  ...
  },
  {
    ...
    sizes: [
      { name: "20'", containerIds: [7] },
      { name: "40'", containerIds: [9] },
      { name: "40' HC", containerIds: [8] },
    ],
  },
  {
